...
CREATE TABLE staff (
  ...
  staff_company_email VARCHAR(150) NOT NULL,
  staff_personal_email VARCHAR(150),
...
CREATE TABLE salary_deduction (
  ...
  FOREIGN KEY (salary) REFERENCES salary (salary_id) 
);
...
CREATE TABLE academic_help_sessions (
  ...
  ah_session_length INTERVAL NOT NULL,
